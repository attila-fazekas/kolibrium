...
package dev.kolibrium.api.core.vinylstore

import dev.kolibrium.api.core.vinylstore.models.generated.vinylStoreApiTest
...
class VinylStoreTest {
    ...
    fun `update vinyls returns 200`() =
        vinylStoreApiTest {
            val vinyl =
                listVinyls().body.vinyls.first { vinyl ->
                    vinyl.album == "Nevermind"
                }

            val response =
                updateVinyl(vinyl.id) {
                    price = 18.00
                }
