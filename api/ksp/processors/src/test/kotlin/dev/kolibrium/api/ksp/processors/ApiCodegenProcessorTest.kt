...
class ApiCodegenProcessorTest : ApiBaseTest() {
    ...
    @Nested
    inner class `18 — Header Parameter Validation` {
        @Test
        fun `18_1 — Valid header with custom name generates header call`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
        ...
        @Test
        fun `18_2 — Header with default property name uses property name as header name`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
        ...
        @Test
        fun `18_3 — Header missing Transient rejected`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
        ...
        @Test
        fun `18_4 — Non-nullable header rejected`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
        ...
        @Test
        fun `18_5 — Unsupported header type rejected`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
        ...
        @Test
        fun `18_6 — Invalid HTTP header name rejected`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
        ...
        @Test
        fun `18_7 — Header combined with Path rejected`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
        ...
        @Test
        fun `18_8 — Header combined with Query rejected`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
        ...
        @Test
        fun `18_9 — Headers work on POST requests`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
        ...
        @Test
        fun `18_10 — Multiple headers generate multiple header calls`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
        ...
        @Test
        fun `18_11 — Full generated output for header request is correct`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
        ...
        @Test
        fun `18_12 — JVM Transient on header rejected with helpful message`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
        ...
        @Test
        fun `18_13 — Duplicate header names with identical explicit names rejected`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
            ...
            val compilation = getCompilation(validApiSpec, request).compile()
            compilation.exitCode shouldBe COMPILATION_ERROR
            compilation.messages shouldContain "Duplicate HTTP header name 'X-Foo'"
        }

        @Test
        fun `18_14 — Duplicate header names differing only in case rejected`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
            ...
            compilation.exitCode shouldBe COMPILATION_ERROR
            compilation.messages shouldContain "Duplicate HTTP header name 'X-Foo'"
            compilation.messages shouldContain "resolve to the same header (case-insensitive)"
        }

        @Test
        fun `18_15 — Explicit header name colliding with default property name rejected`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
            ...
            val compilation = getCompilation(validApiSpec, request).compile()
            compilation.exitCode shouldBe COMPILATION_ERROR
            compilation.messages shouldContain "Duplicate HTTP header name 'accept'"
        }

        @Test
        fun `18_16 — Reserved header name Host emits warning`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
        ...
        @Test
        fun `18_17 — Reserved header names Content-Length and Transfer-Encoding emit warnings`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
        ...
        @Test
        fun `18_18 — Normal custom header does not emit reserved warning`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
            ...
            val compilation = getCompilation(validApiSpec, request).compile()
            compilation.exitCode shouldBe OK
            compilation.messages shouldContain "" // compiles successfully
            val hasReservedWarning = compilation.messages.contains("reserved HTTP header name")
            hasReservedWarning shouldBe false
        }

        @Test
        fun `18_19 — Int header type accepted and generates toString conversion`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
            ...
            compilation.exitCode shouldBe OK
            val source = kotlinCompilation.getGeneratedSource("TestClient.kt")
            source shouldContain "limit: Int? = null"
            source shouldContain """limit?.let { header("X-Limit", it.toString()) }"""
        }

        @Test
        fun `18_20 — Boolean header type accepted and generates toString conversion`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
            ...
            compilation.exitCode shouldBe OK
            val source = kotlinCompilation.getGeneratedSource("TestClient.kt")
            source shouldContain "debug: Boolean? = null"
            source shouldContain """debug?.let { header("X-Debug", it.toString()) }"""
        }

        @Test
        fun `18_21 — String header does not generate toString conversion`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
            ...
            compilation.exitCode shouldBe OK
            val source = kotlinCompilation.getGeneratedSource("TestClient.kt")
            source shouldContain """trace?.let { header("X-Trace", it) }"""
            val hasToString = source.contains("""trace?.let { header("X-Trace", it.toString()) }""")
            hasToString shouldBe false
        }

        @Test
        fun `18_22 — Header without default value rejected`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
            ...
            val compilation = getCompilation(validApiSpec, request).compile()
            compilation.exitCode shouldBe COMPILATION_ERROR
            compilation.messages shouldContain "@Header parameter 'accept' must have a default value (e.g., = null)"
        }

        @Test
        fun `18_23 — Query without default value rejected`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
            ...
            val compilation = getCompilation(validApiSpec, request).compile()
            compilation.exitCode shouldBe COMPILATION_ERROR
            compilation.messages shouldContain "@Query parameter 'search' must have a default value (e.g., = null)"
        }

        @Test
        fun `18_24 — Path, Header, and body together on POST`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
        ...
        @Test
        fun `18_25 — Path, Query, and Header together on GET`() {
            val request =
                kotlin(
                    "Requests.kt",
                    """
