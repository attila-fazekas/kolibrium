...
import dev.kolibrium.selenium.dsl.creation.Arguments.Edge.inPrivate
...
import dev.kolibrium.selenium.dsl.creation.safariDriver
...
/**
 * Factory function that creates a new WebDriver instance for use by Kolibrium DSL helpers such as [dev.kolibrium.selenium.dsl.seleniumTest].
 *
 * Prefer the predefined factories in dev.kolibrium.selenium.dsl.selenium.DriverFactories for common setups
