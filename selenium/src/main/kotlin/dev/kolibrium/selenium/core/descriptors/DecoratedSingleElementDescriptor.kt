...
/**
 * Decorator-aware variant of [SingleElementDescriptor].
 *
...
public class DecoratedSingleElementDescriptor internal constructor(
...
) : SingleElementDescriptor(searchCtx, value, locatorStrategy, cacheLookup, waitConfig, readyWhen) {
