...
import dev.kolibrium.selenium.Browser
import dev.kolibrium.selenium.dsl.creation.Arguments.Chrome
import dev.kolibrium.selenium.dsl.creation.Arguments.Chrome.incognito
import dev.kolibrium.selenium.dsl.creation.ExperimentalFlags.cookies_without_same_site_must_be_secure
import dev.kolibrium.selenium.dsl.creation.ExperimentalFlags.same_site_by_default_cookies
import dev.kolibrium.selenium.dsl.creation.ExperimentalFlags.use_automation_extension
import dev.kolibrium.selenium.dsl.creation.Preferences.Chromium.download_default_directory
import dev.kolibrium.selenium.dsl.creation.Preferences.Chromium.safebrowsing_enabled
import dev.kolibrium.selenium.dsl.creation.Preferences.Firefox.browser_download_folderList
import dev.kolibrium.selenium.dsl.creation.Preferences.Firefox.browser_download_manager_alertOnEXEOpen
import dev.kolibrium.selenium.dsl.creation.Preferences.Firefox.browser_download_manager_closeWhenDone
import dev.kolibrium.selenium.dsl.creation.Preferences.Firefox.browser_download_manager_focusWhenStarting
import dev.kolibrium.selenium.dsl.creation.Preferences.Firefox.browser_download_manager_showAlertOnComplete
import dev.kolibrium.selenium.dsl.creation.Preferences.Firefox.browser_download_manager_showWhenStarting
import dev.kolibrium.selenium.dsl.creation.Preferences.Firefox.browser_download_manager_useWindow
import dev.kolibrium.selenium.dsl.creation.Preferences.Firefox.browser_download_useDownloadDir
import dev.kolibrium.selenium.dsl.creation.Preferences.Firefox.browser_helperApps_alwaysAsk_force
import dev.kolibrium.selenium.dsl.creation.Preferences.Firefox.browser_helperApps_neverAsk_saveToDisk
import dev.kolibrium.selenium.dsl.creation.Preferences.Firefox.network_automatic_ntlm_auth_allow_non_fqdn
import dev.kolibrium.selenium.dsl.creation.Preferences.Firefox.network_automatic_ntlm_auth_trusted_uris
import dev.kolibrium.selenium.dsl.creation.Preferences.Firefox.network_http_phishy_userpass_length
import dev.kolibrium.selenium.dsl.creation.Preferences.Firefox.network_negotiate_auth_delegation_uris
import dev.kolibrium.selenium.dsl.creation.Preferences.Firefox.network_negotiate_auth_trusted_uris
import dev.kolibrium.selenium.dsl.creation.Preferences.Firefox.network_proxy_no_proxies_on
import dev.kolibrium.selenium.dsl.creation.Preferences.Firefox.security_csp_enable
import dev.kolibrium.selenium.dsl.creation.Switches.enable_automation
